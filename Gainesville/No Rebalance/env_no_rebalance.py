...
class Operation:
    ...
    """
    def __init__(self, N, deploy_cost, docked_cost, no_scooter_penalty, pickup_reward, max_scooter_per_area, equity_penalty, rider_test_list, logistics_car_cost_per_mile):
        self.N = N
