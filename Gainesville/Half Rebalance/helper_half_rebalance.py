from env_v11_13_limited_rebalance import *
...
def create_study_area(services, max_scooter_per_area, deploy_cost, docked_cost, N, no_scooter_penalty, pickup_reward, \
                   equity_penalty, rider_test_list, logistics_car_cost_per_mile, logistics_car_capacity):
    ...
    study_area = Operation(N, deploy_cost, docked_cost, no_scooter_penalty, pickup_reward, max_scooter_per_area, equity_penalty, rider_test_list, logistics_car_cost_per_mile, logistics_car_capacity)
