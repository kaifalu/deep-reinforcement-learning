from env_v11_13_max_fixed_scooter_twice import *
...
def create_study_area(services, max_scooter_per_area, deploy_cost, \
                   docked_cost, N, no_scooter_penalty, pickup_reward, equity_penalty, logistics_car_cost_per_mile):
    ...
    study_area = Operation(N, deploy_cost, docked_cost, no_scooter_penalty, pickup_reward, max_scooter_per_area, equity_penalty, logistics_car_cost_per_mile)
...
#                 action = np.random.choice(len(action_probs), p=action_probs)
                ...
                #    print("True")
                # print(action)
                test[j], scooter_list, unmet_demand, met_demand, departure_rate_list = study_area.take_action(0)
