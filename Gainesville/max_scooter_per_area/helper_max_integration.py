...
def create_study_area(services, max_scooter_per_area, deploy_cost, \
                   docked_cost, N, no_scooter_penalty, pickup_reward, equity_penalty, rider_test_list, logistics_car_cost_per_mile, penalty_dist_bus_stop, reward_num_bus_stop):
    ...
    study_area = Operation(N, deploy_cost, docked_cost, no_scooter_penalty, pickup_reward, max_scooter_per_area, equity_penalty, rider_test_list, logistics_car_cost_per_mile, penalty_dist_bus_stop, reward_num_bus_stop)
...
#             scooter_list = scooter_scooter_list[index]
            ...
            scooter_list = scooter_scooter_list[-1]
