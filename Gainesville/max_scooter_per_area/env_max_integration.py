...
class Operation:
    ...
    """
    def __init__(self, N, deploy_cost, docked_cost, no_scooter_penalty, pickup_reward, max_scooter_per_area, equity_penalty, rider_test_list, logistics_car_cost_per_mile, penalty_dist_bus_stop, reward_num_bus_stop):
        self.N = N
    ...
    def take_action_test(self, n=0):
        ...
        if n > 0:
            ...
            reward_move_forward, unmet_demand_list, met_demand_list, departure_rate_list = self.move_forward_test()
            reward += reward_move_forward
